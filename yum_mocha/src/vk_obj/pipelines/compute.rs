...
impl ComputePipelinesBuilder {
    ...
    pub fn build(self, device: Arc<device::Device>, cache: vk::PipelineCache) -> ComputePipelines {
...
impl ComputePipelines {
    pub fn new(device: Arc<device::Device>, layout: vk::PipelineLayout, cache: vk::PipelineCache, shader: &str, entry: &str) -> Self {
