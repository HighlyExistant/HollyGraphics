...
use drowsed_math::linear::{vector::{Vector3, Vector4}, traits::Number, FVec3, FVec4, FMat4, matrix::{Matrix2, Matrix4}, transform};

use super::{simplex::Simplex, collider::CollisionInfo};
...
fn furthest_point<T: Number>(direction: Vector3<T>, vertices: &Vec<Vector3<T>>, transform: &Matrix4<T>) -> Vector3<T>{
...
fn minkowski_support<T: Number>(direction: Vector3<T>, vertices1: &Vec<Vector3<T>>, vertices2: &Vec<Vector3<T>>, transform1: &Matrix4<T>, transform2: &Matrix4<T>) -> Vector3<T>  {
...
fn epa(simplex: Simplex<FVec3, 4>, vertices1: &Vec<Vector3<f32>>, vertices2: &Vec<Vector3<f32>>, transform1: &FMat4, transform2: &FMat4) -> Option<(CollisionInfo)> {
...
pub fn gjk(vertices1: &Vec<Vector3<f32>>, vertices2: &Vec<Vector3<f32>>, transform1: &FMat4, transform2: &FMat4) -> (Option<(CollisionInfo)>) {
