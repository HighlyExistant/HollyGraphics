use drowsed_math::{linear::{FVec3, Transform, TransformQuaternion3D, FMat3}, complex::quaternion::Quaternion};
#[derive(Clone, Copy)]
...
impl RigidBody {
    ...
    pub fn step(&mut self, deltatime: f32, gravity: FVec3, transform: &TransformQuaternion3D) -> TransformQuaternion3D {
        // apply gravity
